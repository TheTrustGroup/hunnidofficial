          ...
          {!isVoided && !isCancelled && delivery.deliveryStatus !== 'delivered' && (
            <div className="px-4 py-3 flex flex-wrap gap-2">
              {delivery.deliveryStatus === 'pending' && (
                ...
                >
                  {loading ? <LoadingSpinner size="sm" /> : <IconTruck />}
                  Mark Dispatched
                </button>
              )}
              <button
              ...
              >
                {loading ? <LoadingSpinner size="sm" /> : <IconCheck />}
                Mark Delivered
              </button>
              <button
                type="button"
              ...
              >
                {loading ? <LoadingSpinner size="sm" /> : 'Cancel delivery'}
              </button>
            </div>
          )}
      ...
      <div className="px-4 pt-4 space-y-3">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 text-slate-400">
            ...
            <p className="text-[13px] mt-4 font-medium">Loading deliveries…</p>
          </div>
        )}
