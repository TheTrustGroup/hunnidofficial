...
export function Reports() {
  ...
  /** Dashboard totals (totalProducts, totalStockValue, etc.) so Reports matches Dashboard/Inventory. */
  ...
  /** Inventory report with totals from dashboard API when available (so Total Products etc. match Dashboard/App). */
