...
4. Open the local **`.github/workflows/ci.yml`** at the **repository root** (e.g. HunnidOfficial; if the repo root is the warehouse-pos folder, it is there). Copy its entire contents and paste into the GitHub editor.
