...
| Script | Purpose |
|--------|--------|
| `audit_schema_hunnid.sql` | **Safe migration first step.** Audit current schema: triggers, views, functions/RPCs, indexes, constraints, key table columns, pg_cron jobs, RLS. Run in Hunnid Supabase SQL Editor to see what already exists before planning migrations. |
