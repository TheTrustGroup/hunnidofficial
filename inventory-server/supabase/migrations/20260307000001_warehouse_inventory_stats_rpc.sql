-- EDK migration at new timestamp (Hunnid kept 20260304120000_search_and_filter_indexes).
...
-- Does NOT duplicate get_warehouse_stats(uuid): different name and return type (TABLE vs json).
