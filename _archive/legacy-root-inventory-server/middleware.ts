...
/** Hostname suffixes to allow (e.g. vercel.app, hunnidofficial.com). */
const DEFAULT_SUFFIXES = ['vercel.app', 'hunnidofficial.com'];
...
function corsHeaders(request: NextRequest): HeadersInit {
  ...
  if (origins.includes('*')) {
    ...
    allowOrigin = allowed ? origin : origins[0] ?? 'https://warehouse.hunnidofficial.com';
  } else {
    allowOrigin = origins[0] ?? 'https://warehouse.hunnidofficial.com';
  }
